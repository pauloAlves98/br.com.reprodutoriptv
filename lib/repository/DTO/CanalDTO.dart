...
class CanalDTO implements ICanal {
  ...
  CanalDTO._internal();
  static CanalDTO? get instance => _instance == null? CanalDTO._internal():_instance;
  ...
  Future<int> getCountCanaisPorLista(int idlista) {
      return Future<int>.delayed(Duration(seconds: 0), () async {//Pode tirar esse deleyed!
      ...
      for (Map m in listMap) { //pq retorna map!
        //print(m.keys);
