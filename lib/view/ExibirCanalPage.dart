    ...
    return Scaffold(
          ...
          ? AppBar(
              flexibleSpace: Container(
                ...
                child: FlexibleSpaceBar(
                  title: Text(
                    Corrente.canalCorrente == null ? "Canal Nulo" : Corrente.canalCorrente!.nome,
              ...
              leading: Center(
               ...
               Navigator.of(context).pushNamedAndRemoveUntil(HOMEPAGE, (rou) => false);
                      })),
              actions: [],
            )
          : null,
      body: Container(
        ...
        child: CustomScrollView(slivers: [
          SliverToBoxAdapter(
            child: Column(
              //colocar em um list view.
              children: [
                Container(
                  height: MediaQuery.of(context).size.height - 100,
                  child: Align(
                    alignment:
                        !fullscreen ? Alignment.center : Alignment.topCenter,
                    child: Padding(
